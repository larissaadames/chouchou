// ─── Cozinha ──────────────────────────────────────────────────────────────────
// Cômodo onde o Chouchou come — futuramente terá o minigame de alimentação.
// ──────────────────────────────────────────────────────────────────────────────
...
class Cozinha {
  ...
  draw() {
    ...
    for (let y = 70; y < height * 0.58; y += 40) {
      line(0, y, width, y)
    }
    noStroke()
    ...
    ellipse(width/2 + 26, height * 0.505, 34, 34)
    // Chamas (quando tem algo cozinhando — decorativo por enquanto)
    fill('#e94560')
